...
rm results/midres/*.png; time python imfit.py images/zz_rect.png -w images/zz_rect_weights.png -s 96 -T 384 -a 0.1 -i results/weights_lores.txt -o results/weights_midres.txt -S -x results/midres/out

# ???
#rm results/hires/*png; time python imfit.py images/zz_rect.png -w images/zz_rect_weights.png -s 128 -T 512 -a0.05 -R 0.0002 -i results/weights_midres.txt -o results/weights_hires.txt -S -x results/hires/out
