...
time python imfit.py images/zz_rect.png -w images/zz_rect_weights.png \
     -s 64 -T 256 -a 0.01 \
     -o results/weights_lores.txt \
     -S -x results/lores/out
